          ...
          <div className="flex items-center justify-between pl-2">
            {character ? (
              <div className="flex flex-col">
                ...
                <p>{known_for[0].title !== undefined ? `${known_for[0].title}` : null }</p>
                <p>{known_for[0].title !== undefined && known_for[1].title !== undefined  ? ',' : null }&nbsp;</p>
                <p>{known_for[1].title !== undefined ? `${known_for[1].title}` : null }</p>
              </div>
            ) : null}
          </div>
        </div>
