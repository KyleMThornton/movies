    ...
    return (
        <div className="relative bg-slate-950 h-128">
            ...
            <div className="container relative flex flex-col justify-center items-center text-center h-full p-5">
                <h1 className="text-4xl md:text-6xl font-bold text-white">Welcome to the Entertainment Database!</h1>
                <a href="https://developer.themoviedb.org/reference/intro/getting-started"><h2 className="text-xl md:text-2xl font-extralight text-white hover:text-blue-300">powered by TMDB</h2></a>
