    ...
    <div className="bg-slate-800 sticky top-0 z-10">
      <nav className="container flex flex-col md:flex-row justify-between p-4 items-center">
        <ul className="flex cursor-pointer pb-5 md:pb-0 text-slate-50 items-center">
          <Link href="/">
            <li className="px-2 text-xl animated-underline">Home</li>
          </Link>
          <Link href="/search/movie">
            <li className="px-2 text-xl animated-underline">Movies</li>
          </Link>
          <Link href="/search/tv">
            <li className="px-2 text-xl animated-underline">TV</li>
          </Link>
          <Link href="/search/person">
            <li className="px-2 text-xl animated-underline">People</li>
          </Link>
          <ThemeSwitcher />
        </ul>
        <form onSubmit={handleSubmit}>
          <div className="flex join">
            <input
              ...
              className="input input-bordered join-item wd-1/3 md:w-80"
            />
